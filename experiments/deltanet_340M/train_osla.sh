...
# Training script for DeltaNet 340M with OSLA
# This script launches distributed training on 8 GPUs

set -e

# Configuration
# Use 2 truly contiguous GPUs (0,1) to match baseline
...
CONFIG_PATH="${SCRIPT_DIR}/configs/deltanet_340M_osla.json"
OUTPUT_DIR="${SCRIPT_DIR}/outputs/deltanet_340M_osla"
WANDB_PROJECT="fla-deltanet-osla-comparison"
RUN_NAME="deltanet-340M-osla-pg19"

echo "============================================"
echo "Training DeltaNet 340M with OSLA"
echo "============================================"
